...
1-2 & \tableicon{moofahS} Moofah & 15+1d8\\
3-4 & \tableicon{bullfangoS} Bullfango$\times$1d2 & 20+1d8\\
5-6 & \tableicon{hermitaurS} Hermitaur & 10+1d8\\
7-8 & \tableicon{epiothS} Epioth & 3d4$\times$10\\
9-10 & \tableicon{aptonothS} Aptonoth & 4d4$\times$20
\end{hbNarrowTable}
...
Deserts challenge the survivalist in a very unique way: It is scorching hot by day and freezing cold by night, requiring very different clothing and shelter. In addition, water requirements are doubled while in a desert.
...
3-4 & \tableicon{delexS} Delex$\times$1d2 & 20+1d8\\
5-6 & \tableicon{hermitaurS} Hermitaur & 10+1d8\\
7-8 & \tableicon{konchuS} Konchu & 3d4\\
9-10 & \tableicon{apcerosS} Apceros & 4d4$\times$20
\end{hbNarrowTable}
...
1-3 & \tableicon{ore-grey} Iron Ore\\
4-7 & \tableicon{ore-blue} Machalite Ore\\
8-11 & \tableicon{ore-white} Earth Crystal\\
...
\textbf{d10} & \textbf{Monster} & \textbf{Lbs. of Meat}\\
1-2 & \tableicon{moofahS} Moofah & 15+1d8\\
3-4 & \tableicon{aptonothS} Aptonoth & 4d4$\times$20\\
5-6 & \tableicon{bullfangoS} Bullfango$\times$1d2 & 20+1d8\\
7-8 & \tableicon{kelbiS} Kelbi$\times$1d4 & 15+1d8\\
9-10 & \tableicon{mosswineS} Mosswine$\times$1d4 & 15+1d12
\end{hbNarrowTable}
